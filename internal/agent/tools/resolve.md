...
- Your final textual answer should be exactly one `<proposed_plan>...</proposed_plan>` block summarizing the plan. Do not duplicate the full plan in chat outside this block.
