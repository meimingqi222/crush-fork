...
func (q *Queries) CreateSession(ctx context.Context, arg CreateSessionParams) (Session, error) {
	...
	err := row.Scan(
		...
		&i.GoalLastReason,
		&i.GoalVerifierID,
		&i.GoalLastEvaluatorMet,
		&i.GoalLastEvaluatorAt,
	)
	return i, err
}
...
func (q *Queries) UpdateSession(ctx context.Context, arg UpdateSessionParams) (Session, error) {
	row := q.queryRow(ctx, q.updateSessionStmt, updateSession,
		...
		arg.GoalUpdatedAt,
		arg.GoalTasks,
		arg.GoalMaxIterations,
		arg.GoalBlockCap,
		arg.GoalIterations,
		arg.GoalNoProgress,
		arg.GoalLastReason,
		arg.GoalVerifierID,
		arg.GoalLastEvaluatorMet,
		arg.GoalLastEvaluatorAt,
		arg.PromptTokens,
		arg.CompletionTokens,
